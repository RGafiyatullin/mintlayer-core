...
use common::{
    chain::{
        ...
        tokens::OutputValue,
        AccountInput, AccountType, ConsensusUpgrade, Destination, GenBlock, Genesis, NetUpgrades,
        OutPoint, OutPointSourceId, PoSChainConfig, PoolId, TxInput, TxOutput, UpgradeVersion,
    },
